...
--                  - CREATE OR ALTER
--------------------------------------------------------------------------------
create or alter procedure [dbo].[script_definition]
...
--exec master.dbo.script_definition 'outcomes_mart', @create_or_alter_header='drop'
--exec master.dbo.script_definition 'outcomes_mart', @create_or_alter_header='create', @object_name = 'regex_matches'
--exec master.dbo.script_definition 'outcomes_mart', @create_or_alter_header='drop and create'
